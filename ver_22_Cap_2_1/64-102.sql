...
L.ORDINE||' -- '||L.FORMULA ||' -- '|| SUM(NVAL(L.COL1)) ||' < '||   SUM(NVAL(L.COL2))  AS REZULTAT
...
TR.FORMULA,
 ...
 D.RIND IN (TR.RIND1) 
   THEN NVAL(D.COL1) ELSE 0 END) AS COL1,  
 ...
 THEN NVAL(D.COL1) ELSE 0 END)  AS COL2
...
SELECT 1200 AS CAPITOL, 'Rind: 2101-1 >=  2101-2 + 2101-3' AS FORMULA,'2101-1' AS RIND1, '2101-2' AS RIND2,'2101-3' AS RIND3,'2101-4' AS RIND4, '64-102' AS ORDINE    
FROM DUAL 
UNION 
...
HAVING 
SUM(NVAL(L.COL1)) < SUM(NVAL(L.COL2))
